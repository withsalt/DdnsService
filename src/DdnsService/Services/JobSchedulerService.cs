...
namespace DdnsService.Services
{
    public class JobSchedulerService : IJobSchedulerService
    {
        ...
        private JobDescribe CreateJobDescribe()
        {
            ...
            if (interval < 30 || interval > 43200)
            {
                throw new Exception("The interval must be less than 43200 and greater than 30 seconds");
            }
        ...
        {
            IJobDetail result = JobBuilder.Create<DdnsJob>()
